...
\begin{document}
    ...
    \ecvfootnote{Para informações adicionais, por favor visite:\newline
    ...
    \begin{europecv}
        ...
        \ccvitem{Função ou Cargo Ocupado}{\textbf{Programador Android Independente}}
        \ccvitem{Principais Actividades e Responsabilidades}{Concepção e desenvolvimento de aplicações para a plataforma Android com os mais altos requisitos de qualidade, alcançado os mesmos com as melhores práticas e padrões de desenvolvimento e desenho. Actualmente com uma aplicação publicada na Play Store denominada de `Notification Agenda'.}
        ...
        \ccvitem{Principais Actividades e Responsabilidades}{Desenvolvimento de um sistema de gestão de conteúdos (CMS) incluindo diversas aplicações Web como gestão do conteúdo principal, gestão de noticias, gestão de portfólio, formulário de candidaturas online dinâmico e \textit{newsletters}. Isto recorrendo a tecnologias como PHP, MySQL, HTML, CSS e JavaScript.}
        ...
        \ccvitem{Principais Disciplinas / Competências Profissionais}{Técnicas e Linguagens de Programação; Aplicações Informáticas; Introdução às Tecnologias de Informação; Estrutura, Organização e Tratamento de Dados.}
        ...
        \ccvitem{Aptidões e Competências Informáticas}{
            ...
            \begin{itemize}
                ...
                \item Diversos: Android SDK, OpenGL, MVC, Apache HTTP Server, Flex (Gerador de Analise Léxica), Yacc (Gerador de Compilador) e Expressões Regulares.
            \end{itemize}
            \\ &
            \vspace{-12pt}
            \begin{itemize}
                ...
                \item Software Computacional: Mathematica, MATLAB.
            \end{itemize}
        }
