...
\begin{document}
    ...
    \begin{europecv}
        ...
        \ccvitem{Datas}{Setembro 2011 $\longrightarrow$ Agosto 2014}
        \ccvitem{Função ou Cargo Ocupado}{\textbf{Programador Android} \textit{(Conta Própria)}}
        \ccvitem{Principais Actividades e Responsabilidades}{Desenvolvimento independente de aplicações para a plataforma Android, utilizando as melhores práticas de desenvolvimento e padrões de desenho. Com a responsabilidade de distribuição no Google Play e \textit{marketing} em redes sociais/publicitárias.}
        ...
        \ccvitem{Principais Actividades e Responsabilidades}{Trabalho \textit{freelance} e remoto em vários websites para múltiplos clientes com soluções de desenvolvimento \textit{front-end} personalizadas, publicação de websites para servidores de produção e manutenção dos mesmos quando necessário.}
