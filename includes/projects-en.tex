...
\ccvitem{Project Summary}{Simple and easy to use .NET library to manage applications user preferences, storing them on a readable XML file.}

\tabularnewline

\ccvitem{\textbf{Other Projects}}{In addition to the most relevant projects outlined above, more can be found on my \href{http://github.com/rfgamaral}{GitHub} profile or on my personal website.}
