...
\begin{document}
    ...
    \ecvfootnote{For additional information, please visit:\newline
    ...
    \begin{europecv}
        ...
        \ccvitem{Occupation or Position Held}{\textbf{Independent Android Programmer}}
        \ccvitem{Main Activities and Responsibilities}{Applications conception and development for the Android platform with the highest requirements for quality, achieving them with best practices and development and design standards. Currently with one application published in the Play Store named `Notification Agenda'.}
        ...
        \ccvitem{Main Activities and Responsibilities}{Development of a content management system (CMS) including various web applications such as main content management, news management, portfolio management, online and dynamic applications form and \textit{newsletters}. This using technologies such as PHP, MySQL, HTML, CSS and JavaScript.}
